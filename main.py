...
- Your explanation should be based on customer's information, the summary statisctics of churned and non-churned customers, and the future importances provided.


    Don't mention the probability of churning, or the machine learning model, or say anything like "Based on machine learning model's prediction and top 10 most important features", just explain the prediction. 
...
def generate_email(probability, input_dict, explanation, surname):
    prompt = f"""You are a manager at SBI Bank. You are responsible for ensuring customers stay with the bank and are incentivized with various offers.
    ...
    At the end of the email, mention your specific designation and relations at the Bank, but don't mention your name.
    """
